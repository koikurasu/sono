...
- Add instructions for installing theme using `deno run -A https://lume.land/init.ts --theme=sono` to README
- Use Lume's init command for the about page's installation instructions
...
[0.1.3]: https://github.com/koikurasu/sono/compare/v0.1.2...v0.1.3
